...
const Navbar = () => {
  ...
  return (
    ...
    <ul className="hidden md:flex md:ml-14 md:space-x-12 md:text-blue-950 md:cursor-pointer md:font-bold">
      ...
      <li><Link to="/product" className="hover:border-b-4 hover:border-blue-950 active:text-blue-400">Products</Link></li>
    ...
    <div className="hidden md:flex md:items-center md:gap-5 md:cursor-pointer">
      <input className="rounded-lg px-5 relative" type="text" placeholder="Search here..." />
      <Link to="/login"><img className="w-5 h-5 active:text-lg active:w-7 active:h-7" src={Account} alt="Account" /></Link>
      {/* <Link to="/#contactus"><img className="w-5 h-5 active:text-lg active:w-7 active:h-7" src={Phone} alt="Phone" /></Link> */}
    ...
    <div className={nav ? "fixed left-0 top-0 w-[60%] border-r border-gray-900 h-full ease-in-out duration-700" : "fixed left-[-100%]"}>
      ...
      <img className="w-20 h-12 bg-blue-950 p-8" src={Logo} alt="Logo" />
