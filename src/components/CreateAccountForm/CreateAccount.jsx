      ...
      <div className="flex flex-col md:flex-row w-full max-w-4xl p-8 bg-white rounded-lg shadow-md">
        ...
        <div className="w-full md:w-1/2 space-y-6 flex flex-col justify-center">
          <form onSubmit={handleSubmit} className="space-y-6">
            <h1 className="text-4xl font-semibold text-center text-blue-600">Create Account</h1>
            <div>
              <input
                type="text"
                name="name"
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="w-40 p-3 text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-200"
              >
                Register
              </button>
            </div>
